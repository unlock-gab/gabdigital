...
export default function About() {
  return (
    <div className="min-h-screen bg-[#F8F9FC] pb-20">
      {/* Hero */}
      <section className="bg-[#0f172a] py-32 pt-40 mb-16 overflow-hidden relative text-white">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
          ...
          >
            من هي <span className="text-orange-500" dir="ltr">GAB Digital؟</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
           ...
           >
              <div className="w-16 h-16 rounded-2xl bg-orange-50 text-orange-500 flex items-center justify-center mx-auto mb-6">
                 <Target size={32} />
              </div>
              <h3 className="text-2xl font-bold mb-4 text-slate-900">رسالتنا</h3>
           ...
           >
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900">رؤيتنا</h3>
              <p className="text-slate-600 leading-relaxed">
           ...
           >
              ...
              <h3 className="text-2xl font-bold mb-4 text-slate-900">قيمنا</h3>
              <p className="text-slate-600 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
           <div>
              <h2 className="text-3xl md:text-4xl font-black mb-6 text-slate-900">لماذا نحن <span className="text-orange-500">مختلفون؟</span></h2>
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                 ...
                 <div className="aspect-[4/3] rounded-2xl bg-orange-50 border border-orange-100 flex items-center justify-center p-6 text-center text-orange-600 font-bold shadow-sm">
                    "نعمل بشغف لأننا نؤمن بقوة التأثير الرقمي"
                 </div>
              </div>
              <div className="space-y-4 pt-8">
                 <div className="aspect-[4/3] rounded-2xl bg-blue-50 border border-blue-100 flex flex-col items-center justify-center p-6 text-center text-blue-600 font-bold shadow-sm">
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-[2rem] p-12 text-center max-w-4xl mx-auto text-white shadow-xl">
